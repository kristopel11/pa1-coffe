<?php
 ...
 ?>
	...
	<!-- start Banner Area -->	
		<section class="generic-banner relative"  style="background-image: url(img/piltikhome.jpg);">	
				<div class="container">
	...
	<!-- start Menu Area -->	
		...
		<section class="menu-area section-gap" id="coffee">
				<div class="container">
								...
								<nav aria-label="breadcrumb">
								  <ol class="breadcrumb">
								    ...
								    <li class="breadcrumb-item"><a href="cpfee.php">Cofeeshop</a></li>
								     <li class="breadcrumb-item"><a href="drink.php">Drink</a></li>
								  </ol>
								</nav>
					...
					<?php $query = $koneksi->query("SELECT * FROM produk_cofeeshop WHERE kategori='food' ");
